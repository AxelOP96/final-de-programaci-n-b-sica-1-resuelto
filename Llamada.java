...
public class Llamada {
	...
	public Llamada(Integer id, String numeroTelefonoOrigen, String numeroTelefonoDestino, Double duracion, TipoLlamada tipoLlamada) {
		this.id = id;
		this.numeroTelefonoOrigen = numeroTelefonoOrigen;
		this.numeroTelefonoDestino = numeroTelefonoDestino;
		this.duracion = duracion;
	...
	public Double obtenerCostoLlamada(TipoLlamada tipoLlamada) {
		Double costo =0.0;
		if(tipoLlamada.equals(TipoLlamada.INTERNACIONAL)) {
	...
	public String toString() {
		return "Llamada [id=" + id + ", numeroTelefonoOrigen=" + numeroTelefonoOrigen + ", numeroTelefonoDestino="
				+ numeroTelefonoDestino + ", duracion=" + duracion + ", tipoLlamada=" + tipoLlamada + "]";
	}
